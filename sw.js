...
const CACHE_VERSION = 'bg-removal-v1.0.1';
const RUNTIME_CACHE = 'bg-removal-runtime-v1';
const ASSETS_CACHE = 'bg-removal-assets-v1';
const MODEL_CACHE = 'bg-removal-models-v1';
